 ...
 * @author nisyaqanita
 */
public class totalTrue extends javax.swing.JFrame {

    /**
     * Creates new form totalTrue
     */
    double fee;
    String textPaid;
    double feePaid;
    ...
    public totalTrue() {
        initComponents();
        fee = 123.65;
        emount.setText("RM" + fee);
        
        checkIn.setText("this is check in date");
        checkOut.setText("this is check out date");
    }
    /**
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(totalTrue.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
